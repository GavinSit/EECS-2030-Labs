...
public class BirthdayBookTester {
	...
	public static void main(String[] args) {
		...
		/*
		 * Return names of persons whose birthdays are January 11. One entry added so
		 * far has this birthday.
		 */
		...
		toRemind = bb.getReminders(1, 11);
		/*
		 * After the entry associated with "A" is deleted, no entries added so far have
		 * this birthday.
		 */
		System.out.println("Number of reminders of January 11: " + toRemind.length);
