...
public class EmployeeInfo implements Comparable<EmployeeInfo> {
	...
	public int compareTo(EmployeeInfo other) {
		/* Your Task */
		EmployeeInfo obj = (EmployeeInfo) other;
		...
		if (this.getSalary() > obj.getSalary()) {
			...
			if (this.getDepartmentId() < obj.getDepartmentId()) {
				return 1;
			} else if (this.getDepartmentId() > obj.getDepartmentId()) {
				return -1;
			}
		}
		return 0;
	...
	public boolean equals(Object obj) {
		...
		if (this.getName() == other.getName() && this.getSalary() == other.getSalary()
